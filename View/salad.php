...
$result = $sanpham->select_danhmuc("Salad"); // Truy vấn sản phẩm theo danh mục "banhtrang"
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php include('navbar.php'); ?>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="col-9">
                <div style="color: #bd784e; font-size: 40px; font-weight: 500; text-align: center; margin-top: 50px; margin-bottom: 10px;">Salad-Rau</div>
                <div class="container">
                    <div class="row">
                        <?php
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                if ($row['danhmuc'] == "Salad") {
                                    echo '
                                    <div class="col-4" style="overflow: hidden; margin-bottom: 30px;">
                                        ...
                                        <div class="product-info" style="text-align: center; margin-top: 5px; color: #a17a6d;">Salad-Rau</div>
