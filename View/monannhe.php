    ...
    <?php include('navbar.php'); ?>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="col-9">
                <div style="color: #bd784e; font-size: 40px; font-weight: 500; text-align: center; margin-top: 30px; margin-bottom: 10px;">Món ăn nhẹ</div>
                <div class="container">
                    <div class="row">
                        <div class="col-4" style="overflow: hidden;">
                            <div class="image-container2">
                              <img src="Media/monnhe1.jpg" class="zoom">
                            </div>
                            <div style="text-align: center; margin-top: 10px; color: #a17a6d;">Món ăn nhẹ</div>
                            <div style="color: #bd784e; font-size: 19px; font-weight: bolder; text-align: center;" >Đậu hũ non hải sản sốt nấm</div>
                            <div style="text-align: center; color: #33524b ; font-size: 19px; font-weight: bolder;">169.000 ₫ – 189.000 ₫</div>
                            <center>
                        ...
                        <div class="col-4" style="overflow: hidden;">
                            <div class="image-container2">
                                <img src="Media/monnhe2.jpg" class="zoom">
                              </div>
                              <div style="text-align: center; margin-top: 10px; color: #a17a6d;">Món ăn nhẹ</div>
                              <div style="color: #bd784e; font-size: 19px; font-weight: bolder; text-align: center;" >Đậu hũ non rang muối</div>
                              <div style="text-align: center; color: #33524b ; font-size: 19px; font-weight: bolder;">95.000 ₫ – 109.000 ₫</div>
                              <center>
                                  <button style="width: 100px; height: 30px; background-color: #601d1b; color: white; font-size: 18px; font-weight: bold; border: none;">Đặt món</button>
                                  <button style="width: 100px; height: 30px; background-color: #33522d; color: white; font-size: 18px; font-weight: bold; border: none;">Chi tiết</button>
                              </center>
                        ...
                        <div class="col-4" style="overflow: hidden;">
                            <div class="image-container2">
                                <img src="Media/monnhe3.jpg" class="zoom">
                              </div>
                              <div style="text-align: center; margin-top: 10px; color: #a17a6d;">Món ăn nhẹ</div>
                              <div style="color: #bd784e; font-size: 19px; font-weight: bolder; text-align: center;" >Đậu hũ non sốt Bò bằm</div>
                              <div style="text-align: center; color: #33524b ; font-size: 19px; font-weight: bolder;">119.000 ₫ – 135.000 ₫</div>
                              <center>
                                  <button style="width: 100px; height: 30px; background-color: #601d1b; color: white; font-size: 18px; font-weight: bold; border: none;">Đặt món</button>
                                  <button style="width: 100px; height: 30px; background-color: #33522d; color: white; font-size: 18px; font-weight: bold; border: none;">Chi tiết</button>
                              </center>
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="col-4" style="overflow: hidden;">
                            <div class="image-container2">
                                <img src="Media/monnhe4.jpg" class="zoom">
                              </div>
                              <div style="text-align: center; margin-top: 10px; color: #a17a6d;">Món ăn nhẹ</div>
                              <div style="color: #bd784e; font-size: 19px; font-weight: bolder; text-align: center;" >Nem nấm hải sản</div>
                              <div style="text-align: center; color: #33524b ; font-size: 19px; font-weight: bolder;">150.000 ₫ – 165.000 ₫</div>
                              <center>
                                  <button style="width: 100px; height: 30px; background-color: #601d1b; color: white; font-size: 18px; font-weight: bold; border: none;">Đặt món</button>
                                  <button style="width: 100px; height: 30px; background-color: #33522d; color: white; font-size: 18px; font-weight: bold; border: none;">Chi tiết</button>
                              </center>
                        ...
                        <div class="col-4" style="overflow: hidden;">
                            <div class="image-container2">
                              ...
                              <div style="text-align: center; margin-top: 10px; color: #a17a6d;">Món ăn nhẹ</div>
                              <div style="color: #bd784e; font-size: 19px; font-weight: bolder; text-align: center;" >Nem Ốc</div>
                              <div style="text-align: center; color: #33524b ; font-size: 19px; font-weight: bolder;">130.000 ₫ – 149.000 ₫</div>
                              <center>
                                  <button style="width: 100px; height: 30px; background-color: #601d1b; color: white; font-size: 18px; font-weight: bold; border: none;">Đặt món</button>
                                  <button style="width: 100px; height: 30px; background-color: #33522d; color: white; font-size: 18px; font-weight: bold; border: none;">Chi tiết</button>
                              </center>
                        ...
                        <div class="col-4" style="overflow: hidden;">
                            <div class="image-container2">
                                <img src="Media/monnhe6.jpg" class="zoom">
                              </div>
                              <div style="text-align: center; margin-top: 10px; color: #a17a6d;">Món ăn nhẹ</div>
                              <div style="color: #bd784e; font-size: 19px; font-weight: bolder; text-align: center;" >Khoai Tây chiên</div>
                              <div style="text-align: center; color: #33524b ; font-size: 19px; font-weight: bolder;">59.000 ₫ – 69.000 ₫</div>
                              <center>
                                  <button style="width: 100px; height: 30px; background-color: #601d1b; color: white; font-size: 18px; font-weight: bold; border: none;">Đặt món</button>
                                  <button style="width: 100px; height: 30px; background-color: #33522d; color: white; font-size: 18px; font-weight: bold; border: none;">Chi tiết</button>
                              </center>
